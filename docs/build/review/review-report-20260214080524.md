...
- Specs: `docs/spec/01-12` (with emphasis on `docs/spec/12-reliability-compat-testing.md`)
...
Evidence:
- Spec requires command set and config lifecycle: `docs/spec/09-configuration-cli.md:83`, `docs/spec/09-configuration-cli.md:115`, `docs/spec/10-daemon-operations.md:7`.
...
Evidence:
- Spec precedence: status fast-path only for explicit status commands; otherwise route to run: `docs/spec/02-queue-processing.md:53`, `docs/spec/05-workflow-orchestration.md:424`.
...
Evidence:
- Spec requires provider CLI execution for selector, step, diagnostics: `docs/spec/03-agent-routing-execution.md:27`, `docs/spec/06-provider-integration.md:9`.
...
Evidence:
- Spec requires discord/telegram/whatsapp/slack adapters: `docs/spec/07-channel-adapters.md:7`.
...
Evidence:
- Spec requires heartbeat worker and 15-minute progress cadence: `docs/spec/11-heartbeat-service.md:9`, `docs/spec/05-workflow-orchestration.md:507`.
...
Evidence:
- Spec requires two-phase diagnostics with bounded retrieval and provenance: `docs/spec/05-workflow-orchestration.md:268`, `docs/spec/05-workflow-orchestration.md:299`, `docs/spec/05-workflow-orchestration.md:333`.
...
Evidence:
- Spec requires selector-callable parity for CLI/daemon commands with argument schema metadata: `docs/spec/09-configuration-cli.md:184`, `docs/spec/10-daemon-operations.md:24`.
...
Evidence:
- Spec mandates migrate command and legacy compatibility: `docs/spec/12-reliability-compat-testing.md:31`, `docs/spec/12-reliability-compat-testing.md:33`.
