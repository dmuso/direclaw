...
| RB-4 | CI gates pass, including E2E and docs checks. | P00-T02, P00-T04, P05-T01, P06-T04 | `tests/docs_phase00_baseline.rs::markdown_links_and_paths_resolve_for_contributor_and_operator_docs`; `tests/docs_phase00_baseline.rs::every_phase_task_section_has_required_status_acceptance_and_automated_test_blocks`; `tests/release_gate_phase06.rs::release_gate_fails_when_any_blocker_is_violated` |
| RB-5 | GitHub release workflow publishes expected binaries and checksums. | P05-T02, P05-T03, P05-T04, P06-T04 | `tests/release_gate_phase06.rs::release_gate_passes_with_all_blockers_satisfied`; `tests/release_gate_phase06.rs::release_gate_fails_when_any_blocker_is_violated` |
| RB-6 | User docs and operator docs are complete and validated from clean environment install. | P00-T01, P06-T01, P06-T02, P06-T05 | `tests/docs_phase00_baseline.rs::v1_scope_docs_are_slack_only_and_deferred_channels_are_roadmapped`; `tests/docs_phase06_hardening.rs::user_guide_entrypoint_covers_install_first_run_and_integrations`; `tests/docs_phase06_hardening.rs::docs_clean_install_smoke_script_runs_in_ci_like_environment` |
